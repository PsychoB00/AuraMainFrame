pub const packages = struct {
    pub const @"AuraCore-0.0.1-sHn8yLAvAADuncL2HNntPo1A5LCnRWbzLan-E78t_4Uu" = struct {
        pub const build_root = "/home/dan/.cache/zig/p/AuraCore-0.0.1-sHn8yLAvAADuncL2HNntPo1A5LCnRWbzLan-E78t_4Uu";
        pub const build_zig = @import("AuraCore-0.0.1-sHn8yLAvAADuncL2HNntPo1A5LCnRWbzLan-E78t_4Uu");
...
pub const root_deps: []const struct { []const u8, []const u8 } = &.{
    .{ "core", "AuraCore-0.0.1-sHn8yLAvAADuncL2HNntPo1A5LCnRWbzLan-E78t_4Uu" },
    .{ "zap", "zap-0.9.1-GoeB85JTJAADY1vAnA4lTuU66t6JJiuhGos5ex6CpifA" },
    .{ "jwt", "jwt-0.0.1-HbWOu6Y-AAAazOpY5quBwgxLtHBcZxtfMn7OCim45glZ" },
};
